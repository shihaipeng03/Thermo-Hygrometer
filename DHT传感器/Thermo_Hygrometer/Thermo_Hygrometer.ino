...
#include <dht.h>
//如果报错缺少此库文件，操作如下
//在arduino IDE的菜单中选择 项目->加载库->管理库（热键 按Ctrl+Shift+I打开） TinyStepper_28BYJ_48 或 dht，并安装，重新编译即可
...
//接线方法 
#define DHT11Pin 2       //  温湿度模块 接arduino的 2# 端口
...
void loop()  
{
  ...
  int chk = DHT.read11(DHT11Pin);
  int n_humi= DHT.humidity;
  int n_temp= DHT.temperature;  //读取当前湿度 和 温度
